            ...
            <section id="dashboard">
                <div id="status">
                    <div id="Booking" class="info-box status-item">
                        ...
                        <a href="./booking.php">View<i class="fas fa-eye"></i></a>
                    </div>
                    <div id="Bus" class="info-box status-item">
                        ...
                        <a href="./bus.php">View<i class="fas fa-eye"></i></a>
                    </div>
                    <div id="Route" class="info-box status-item">
                        ...
                        <a href="./route.php">view<i class="fas fa-eye"></i></a>
                    </div>
                    <div id="Seat" class="info-box status-item">
                        ...
                        <div class="info-content">
                            <p>Total Seats</p>
                            <p class="num" data-target="<?php 
                                    echo 41 * count($busData);
                                ?>">
                                999
                            </p>
                        </div>
                        <a href="./seat.php">View<i class="fas fa-eye"></i></a>
                    </div>
                </div>
                <!-- <h3>User</h3> -->
                <div id="user">
                    <div id="Customer" class="info-box user-item">
                        ...
                        <a href="./customer.php">View<i class="fas fa-eye"></i></a>
                    </div>
                    ...
                    <?php 
                        ...
                        ?>
                            <div class="info-box admin-item">
                                <img src="../assets/img/userav-min.png" height="100px" alt="Profile Pic">
