                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        ...
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                Click<button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">ADD <i class="fas fa-plus"></i></button> to add a customer!
                        </div>
                    </div>
                </div>
            <?php }
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                   delete these customer details? <strong>process cannot be undone.</strong>
                </p>
                <!-- Needed to pass id -->
