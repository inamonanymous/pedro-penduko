        ...
        */
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noRoutes" class="alert alert-dark " role="alert">
                        ...
                        <p class="fw-light">would you like to add one!</p>
                        <hr>
                        <div id="addRouteAlert" class="alert alert-success" role="alert">
                                Click <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">ADD <i class="fas fa-plus"></i></button> to add a route!
                        </div>
                    </div>
                </div>
            <?php }
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addRouteForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                    <label for="viaCities" class="form-label">ROUTE DESTINATION</label>
                                <input type="text" class="form-control" id="viaCities" name="viaCities" placeholder="FROM SOURCE,TO DESTINATION" required>
                                <span id="error">
                            ...
                            <div class="mb-3">
                                <label for="busno" class="form-label">PLATE NUMBER</label>
                            ...
                            <div class="mb-3">
                                <label for="stepCost" class="form-label">PRICE</label>
                            ...
                            <button type="submit" class="btn btn-success" id="button" name="submit">ADD</button>
                        </form>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                   delete this route? <strong>process cannot be undone.</strong>
                </p>
                <!-- Needed to pass id -->
            ...
            <div class="modal-footer d-flex justify-content-center">
                ...
                <button type="submit" id="submit" form="delete-form" name="delete" class="btn btn-danger">Delete</button>
            </div>
            </div>
        </div>
        </div>
