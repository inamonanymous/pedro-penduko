                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        ...
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                Click <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">ADD <i class="fas fa-plus"></i></button> to add a bus!
                        </div>
                    </div>
                </div>
            <?php }
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addBusForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                <label for="busnumber" class="form-label">PLATE NUMBER</label><br>

                                </span>
                                <input type="text" class="form-control" id="busnumber" name="busnumber" placeholder="EX. ABC123"required>
                                <span id="error" class="error">
                            </div>
                            <button type="submit" id="button" class="btn btn-success" name="submit">ADD</button>
                        </form>
                    </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    delete this bus? <strong>process cannot be undone.</strong>
                </p>
                <!-- Needed to pass id -->
