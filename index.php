    ...
    <header>
        <nav>
            ...
            <ul>
                ...
                <a href="#" class="booking nav-item" data-bs-toggle="modal" data-bs-target="#bookingModal" onclick="navToBookRide()"><i class="fas fa-book" style="margin-right: 0.4rem;"></i>Book Now</a>
            </ul>
        </nav>
    </header>
    <!-- Login Modal -->
    ...
    <section id="home">
        <section id="pnr-enquiry">
            <div id="pnr-form">
                ...
                <form action="<?php echo $_SERVER["REQUEST_URI"]; ?>" method="POST">
                    <div>
                        <input type="text" name="pnr" id="pnr" placeholder="ENTER CONTROL NUMBER">
                    </div>
        ...
        <section id="about">
            <div>
                ...
                <p>
                Lucena Lines Inc. (LLI) is a bus operating company in the Philippines. It is a subsidiary of JAC Liner Inc. and commenced its own operations in December 2004.
                It has operations from Manila to Lucena in the province of Quezon, Pagsanjan and Santa Cruz in the province of Laguna.
                </p>
            </div>
        </section>
        <section id="contact">
            <h4>For Seat Reservation Appointment</h4>
        <footer>Contact Us At: proacepro1234@gmail.com</footer>
        </section>
